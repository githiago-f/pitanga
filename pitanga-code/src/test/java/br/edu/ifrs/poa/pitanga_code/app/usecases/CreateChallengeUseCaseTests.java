...
public class CreateChallengeUseCaseTests {
    ...
    @BeforeEach
    public void setup() {
        challengesRepository = Mockito.mock(ChallengesRepository.class);
    ...
    public void shouldAllowEveryLanguageIfNoneIsListed() {
        CreateChallengeUseCase useCase = new CreateChallengeUseCase(challengesRepository, languagesRepository);
